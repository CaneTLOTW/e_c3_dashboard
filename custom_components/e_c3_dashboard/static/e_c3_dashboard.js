  ...
  static async generate(config, hass) {
      ...
      cards: [
        ...
        },
        {
          ...
          entities: [
            ...
            { type: "attribute", entity: vehicleInfoEntity, attribute: "Bildanzahl", name: language(hass) === "de" ? "Fahrzeugbilder" : "Vehicle pictures" },
            { type: "attribute", entity: vehicleInfoEntity, attribute: "Datenquelle", name: language(hass) === "de" ? "Datenquelle" : "Data source" },
          ],
        },
      ],
    } : null;
    ...
    views.push({
      ...
      sections: [
        ...
        { type: "grid", cards: present([
          { type: "heading", heading: strings.settings, icon: "mdi:cog-outline", heading_style: "title" },
        ...
        { type: "grid", cards: present([
          entity("abrp_sync") || entity("abrp_token") ? { type: "heading", heading: "ABRP", icon: "mdi:map-marker-path", heading_style: "title" } : null,
