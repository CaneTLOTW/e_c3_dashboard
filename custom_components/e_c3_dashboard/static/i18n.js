...
export const FRONTEND_TEXT = {
  ...
  dashboard: {
    en: {
      ...
      batteryHealthCapacity: "SOH capacity", batteryHealthResistance: "SOH resistance", batteryHealthIntro: "These charts use Home Assistant Recorder history and long-term statistics. The displayed range is intentionally large so the complete retained history can be shown.", batteryHealthCapacityChart: "SOH capacity history", batteryHealthResistanceChart: "SOH resistance history", position: "Position", vehicleDetails: "Vehicle",
    ...
    de: {
      ...
      batteryHealthCapacity: "SOH Kapazität", batteryHealthResistance: "SOH Widerstand", batteryHealthIntro: "Diese Diagramme verwenden die HA-Recorder-Historie und Langzeitstatistiken. Der dargestellte Zeitraum ist bewusst groß gewählt, damit die gesamte noch gespeicherte Historie sichtbar wird.", batteryHealthCapacityChart: "SOH-Kapazität – Historie", batteryHealthResistanceChart: "SOH-Widerstand – Historie", position: "Position", vehicleDetails: "Fahrzeug",
