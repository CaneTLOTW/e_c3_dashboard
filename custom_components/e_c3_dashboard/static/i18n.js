...
export const FRONTEND_TEXT = {
  ...
  dashboard: {
    en: {
      ...
      manualWakeup: "Wake vehicle now", system: "System", mappedEntities: "Mapped upstream entities", trips: "Trips", charging: "Charging", gps: "GPS history", wakeup: "Wake-up", notifications: "Notifications", notificationRecipients: "Recipients", notificationSettings: "Notification settings", notificationDiagnostics: "Notification diagnostics", vehicleAlerts: "Vehicle alerts", tripReports: "Trip reports", chargeReports: "Charge reports", hourlyWakeup: "Hourly wake-up", chargeWakeup: "Wake-up while charging", availabilityProbe: "Availability probe", testNotification: "Send test notification",
