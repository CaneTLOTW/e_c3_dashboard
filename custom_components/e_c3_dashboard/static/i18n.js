...
export const FRONTEND_TEXT = {
  ...
  dashboard: {
    en: {
      ...
      manualWakeup: "Wake vehicle now", system: "System", mappedEntities: "Mapped upstream entities", trips: "Trips", charging: "Charging", gps: "GPS history", wakeup: "Wake-up", notifications: "Notifications", notificationRecipients: "Recipients", notificationSettings: "Notification settings", notificationDiagnostics: "Notification diagnostics", notificationSettingsUnavailable: "Notification settings are still being published. Reload this dashboard once if they do not appear shortly.", notificationWarningThresholds: "Warning thresholds", notificationTimingAvailability: "Timing & availability", notificationQuietHours: "Quiet hours", rangeWarning: "Range warning", rangeReset: "Range reset", homeSocWarning: "At-home SOC warning", homeSocReset: "At-home SOC reset", battery12Warning: "12 V warning", battery12Reset: "12 V reset", homeWarningDelay: "At-home warning delay", staleAtHome: "Availability timeout at home", staleAway: "Availability timeout away", probeWait: "Probe wait", chargeStartDelay: "Charge-start delay", quietStart: "Quiet hours start", quietEnd: "Quiet hours end", lastNotificationType: "Last notification type", lastNotificationTime: "Last notification time", lastNotificationMessage: "Last notification message", heartbeatSource: "Heartbeat source", heartbeatTime: "Heartbeat time", outageStatus: "Outage status", outageSince: "Outage since", outageActive: "Active", probeStatus: "Probe status", probeTime: "Last probe", probePending: "Pending",
      help: "Functions & usage", helpContent: "## Using this dashboard\n\n### Trip history\n- Completed trips come from Stellantis server history. Tap a row for mileage and SOC details.\n- A missing or unchanged whole-percent SOC is shown as **—**, not as zero consumption.\n\n### Charging history\n- Tap a row to expand its details. Observed sessions show real Home-Assistant on/off boundaries and can open their charge curve.\n- Reconstructed entries only identify a SOC rise between trips. Their standstill window is not a charging duration; power, type and curve remain unavailable.\n\n### Controls\n- Use Quick actions for preconditioning.\n- Use Charging & range for charging status, charging type, charge end, charging power, cable state, charge limit and charging start.\n\n### GPS and data quality\n- The GPS view shows Recorder-stored positions for the selected period. Sparse points and straight connections between trips are expected when the vehicle API reports only occasional positions.\n- The System view shows the mapped upstream entities and the integration status.",
