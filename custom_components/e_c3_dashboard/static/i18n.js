...
export const FRONTEND_TEXT = {
  ...
  chargeHistory: {
    ...
    en: {
      title: "Charging history", loading: "Loading charge history …",
  ...
  dashboard: {
    en: {
      ...
      tripHistory: "Trip history", chargeHistory: "Charging history", chargeCurves: "Charging curves", historicalChargeCurves: "Historical charging curves", selectChargeCurve: "Select charging curve",
