...
OPTION_TRIP_ENERGY_ENTITY = "trip_energy_entity"
OPTION_CHARGE_POWER_ENTITY = "charge_power_entity"
...
DEFAULT_OPTIONS = {
    ...
    OPTION_TRIP_ENERGY_ENTITY: None,
    OPTION_CHARGE_POWER_ENTITY: None,
}
